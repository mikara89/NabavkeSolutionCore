...
using NabavkeSolutionCore.Models.DB;

namespace NabavkeSolutionCore.Persistence
{
    public partial class aspnet_NabavkeSolution_20170207071425Context : DbContext
    {
     
        public virtual DbSet<Delatnost> Delatnost { get; set; }
        public virtual DbSet<Kategorija> Kategorija { get; set; }
        public virtual DbSet<Mesto> Mesto { get; set; }
        public virtual DbSet<Nabavke> Nabavke { get; set; }
        public virtual DbSet<NabavkeUpdate> NabavkeUpdate { get; set; }
        public virtual DbSet<OblikOrg> OblikOrg { get; set; }
        public virtual DbSet<OblikSvoj> OblikSvoj { get; set; }
        public virtual DbSet<Opstina> Opstina { get; set; }
        public virtual DbSet<Pracenjes> Pracenjes { get; set; }
        public virtual DbSet<UpdateDblogs> UpdateDblogs { get; set; }
        public virtual DbSet<VrstaPostupka> VrstaPostupka { get; set; }

        public aspnet_NabavkeSolution_20170207071425Context(DbContextOptions<aspnet_NabavkeSolution_20170207071425Context> options)
            : base(options){}
